...
public class PantallaPropuestasRealizadas extends JFrame {
	...
	public PantallaPropuestasRealizadas() {
		...
		btnInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				presentacion.PantallaVisualizarCurso a = new presentacion.PantallaVisualizarCurso();
				setVisible(false);
				a.setVisible(true);
	...
	public void infoCurso (presentacion.PantallaVisualizarCurso a,CursoPropio cursoSeleccionado) {
