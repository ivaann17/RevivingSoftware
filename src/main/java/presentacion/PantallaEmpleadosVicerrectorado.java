...
public class PantallaEmpleadosVicerrectorado extends JFrame {
	...
	public PantallaEmpleadosVicerrectorado() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(PantallaEmpleadosVicerrectorado.class.getResource("/resources/IMAGES/descarga.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(
				PantallaEmpleadosVicerrectorado.class.getResource("/resources/IMAGES/Captura de pantalla (188).png")));
		...
		lblNewLabel2.setIcon(new ImageIcon(PantallaEmpleadosVicerrectorado.class.getResource("/resources/IMAGES/images2.jpg")));
		lblNewLabel2.setBounds(549, 55, 142, 143);
		contentPane.add(lblNewLabel2);

		JButton cs = new JButton("Cerrar sesion");
		cs.setIcon(new ImageIcon(PantallaEmpleadosVicerrectorado.class.getResource("/resources/IMAGES/cerrar-sesion .png")));
	...
	protected static JButton crearBotonCerrarSesion(JButton a) {
