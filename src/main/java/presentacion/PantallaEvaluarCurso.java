	...
	public PantallaEvaluarCurso() {
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int respuesta = JOptionPane.showConfirmDialog(null, "�Desea aceptar la propuesta?", "ATENCI�N",
						JOptionPane.OK_CANCEL_OPTION);
				if (respuesta == JOptionPane.OK_OPTION) {
					JOptionPane.showMessageDialog(null, "El curso se ha dado de alta.", "INFORMACI�N",
		...
		btnRechazar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int respuesta = JOptionPane.showConfirmDialog(null, "�Desea rechazar la solicitud?", "Confirmaci�n",
						JOptionPane.OK_CANCEL_OPTION);
				if (respuesta == JOptionPane.OK_OPTION) {
					String mensaje = "";
